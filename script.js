...
const dateFormatter = new LocalDateFormatter();

console.log('EN');
console.log(dateFormatter.formatDate(dateStr, 'full', 'en'));
console.log(dateFormatter.formatDate(dateStr, 'short', 'en'));


console.log();

console.log('Local');
console.log(dateFormatter.formatDate(dateStr, 'full'));
console.log(dateFormatter.formatDate(dateStr, 'short'));
